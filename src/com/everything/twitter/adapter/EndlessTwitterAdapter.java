...
//
//public class EndlessTwitterAdapter extends EndlessAdapter {
//	private RotateAnimation rotate = null;
//	private View pendingView = null;
//
//	EndlessTwitterAdapter(Context ctxt, ArrayList<Integer> list) {
//		new baseA
////		super(new ArrayAdapter<Integer>(ctxt, R.layout.row, android.R.id.text1,
////				list));
